...
# def process_hand(cards, trick_cards, tricks_won, tricks_predicted, hand_size=8):
...
#         if i < len(cards):
#             encoded_hand.append(one_hot_encode_card(cards[i]))
#         else:
...
hand = [
    ...
    # Note: One card is already played, so it should be encoded as a null vector
]
